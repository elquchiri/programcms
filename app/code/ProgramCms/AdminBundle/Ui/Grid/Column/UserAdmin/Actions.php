...
namespace ProgramCms\AdminBundle\Ui\Grid\Column\UserAdmin;
...
/**
 * Class Actions
 * @package ProgramCms\AdminBundle\Ui\Grid\Column\UserAdmin
 */
            ...
            foreach($dataSourceData as $rowData) {
                $actions = [
                    [
                        ...
                        'url' => $this->url->getUrlByRouteName('admin_user_edit', ['id' => $rowData->getEntityId()]),
                        'type' => 'url'
                    ]
                ];
